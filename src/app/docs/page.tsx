          ...
          <main className="flex-1 min-w-0 max-w-4xl">
            <div id="doc-content" className="prose prose-slate max-w-none">
              ...
              <section id="keyboard-shortcuts">
                ...
                <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded mb-4 mt-6">
                  <p className="text-sm text-text-secondary">
                    <strong className="text-text-primary">Tip:</strong> In Focus Mode, keyboard-based drag-and-drop is perfect for quickly prioritizing work. Hold Shift and use arrow keys to move items up or down in priority - much faster than using the mouse!
                  </p>
                </div>
